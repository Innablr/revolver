...
environ.baseBackoff = Number.parseInt(process.env.SDK_BASE_BACKOFF || '300', 10);
environ.connectionTimeout = Number.parseInt(process.env.SDK_CONNECTION_TIMEOUT_MS || '0', 10);
environ.requestTimeout = Number.parseInt(process.env.SDK_REQUEST_TIMEOUT_MS || '0', 10);
environ.maxRetries = Number.parseInt(process.env.SDK_MAX_RETRIES || '30', 10);
