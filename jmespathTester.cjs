...
if (process.argv.length < 4) {
  ...
  console.log(
    '\tJMESPATH - The output will be all resource IDs with whatever this path would return for each resource saved in the JSON',
  );
  console.log('\nEXAMPLES:');
  ...
  console.log(
    `\t\tnode ${scriptName} resources.json "NetworkInterfaces[*].Groups[*].GroupName[] | @[?contains(@, 'default')] | @[0] != null"`,
  );
  process.exit(1);
}
